...
```
local_output/nnMamba_raw/nnUNet_raw_data/Dataset001_ABUS/
...
cp "$nnUNet_raw_data_base/nnUNet_raw_data/Dataset001_ABUS/splits_final.pkl" \
...
│   └── Dataset001_ABUS/               # From local Step 1
